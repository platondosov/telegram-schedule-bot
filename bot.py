...
# Расписание для двух подгрупп
schedule = {
    # Подгруппа 1 (ваше оригинальное расписание)
    1: {
        "Понедельник": {
...
• Английский язык (пз 233-2 общ.)"""
    ...
    # Подгруппа 2 (новое расписание с отличиями)
    2: {
        "Понедельник": {
...
4. Используйте кнопку "🔄 Сменить неделю" для переключения между I и II неделями
